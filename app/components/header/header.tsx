...
export default function Header() {
	...
	<header>
		...
		<div className="min-w-36 flex flex-wrap items-center justify-between p-4 md:p-6 lg:p-8">
			...
			<button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm rounded-lg lg:hidden focus:ring-2 focus:ring-hover-color" aria-controls="mobile-menu-2" aria-expanded="false" onClick={() => setIsVisible((prev) => !prev)}>
